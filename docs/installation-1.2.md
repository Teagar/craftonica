...
```text
mods/craftonica-1.2.0.jar
craftonica-runtime/craftonica-1.2.0-runtime-worker.jar
...
1. Confira `Craftonica: Robotics Lab 1.2.0` na lista de mods.
...
5. Siga o [manual do robo movel](robo-movel-guiado.md) ate o estado `RUNNING`.
6. Em servidor dedicado, confirme que o log nao informa
...
[README](../README.md#migracao-e-rollback-de-mundos). Compatibilidade e diferencas
para hardware real estao em [compatibilidade-1.2.md](compatibilidade-1.2.md).
